 ...
 *
 */
public class XorSimpleNFixedSeed implements Filter {
     ...
     */
    public static XorSimpleNFixedSeed construct(Set<Long> keys, int bitsPerFingerprint, long seed) {
        return new XorSimpleNFixedSeed (keys, bitsPerFingerprint, seed);
    }
     ...
     * @return a new Filter with the selected parameters
     */
    public static XorSimpleNFixedSeed construct(Set<Long> keys, int bitsPerFingerprint, int tSize, long seed) {
        return new XorSimpleNFixedSeed (keys, bitsPerFingerprint, tSize, seed);
    }
     ...
     * @return a new Filter with the selected parameters
     */
    XorSimpleNFixedSeed(Set<Long> keys, int bitsPerFingerprint, long seedInit) {
    	this(keys, bitsPerFingerprint, (int) ((1.23 * keys.size()) + 32), seedInit);
    }
     ...
     * @return a new Filter with the selected parameters
     */
    XorSimpleNFixedSeed(Set<Long> keys, int bitsPerFingerprint, int tsize, long seedInit) {
